...
enum opt_code
{
  ...
  OPT_mdll = 1331,                           /* -mdll */
  OPT_mdump_tune_features = 1332,            /* -mdump-tune-features */
  OPT_mf16c = 1333,                          /* -mf16c */
  OPT_mfancy_math_387 = 1334,                /* -mfancy-math-387 */
  OPT_mfentry = 1335,                        /* -mfentry */
  OPT_mfentry_name_ = 1336,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1337,               /* -mfentry-section= */
  OPT_mfma = 1338,                           /* -mfma */
  OPT_mfma4 = 1339,                          /* -mfma4 */
  OPT_mforce_drap = 1340,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1341,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1342,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1343,                       /* -mfpmath= */
  OPT_mfsgsbase = 1344,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1345,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1346, */              /* -mfused-madd */
  OPT_mfxsr = 1347,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1348,             /* -mgeneral-regs-only */
  OPT_mgfni = 1349,                          /* -mgfni */
  OPT_mhard_float = 1350,                    /* -mhard-float */
  OPT_mhle = 1351,                           /* -mhle */
  OPT_miamcu = 1352,                         /* -miamcu */
  OPT_mieee_fp = 1353,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1354,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1355,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1356,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1357,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1358,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1359,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1360, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1361,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1362,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1363,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1364,                /* -mlong-double-80 */
  OPT_mlwp = 1365,                           /* -mlwp */
  OPT_mlzcnt = 1366,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1367,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1368,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1369,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1370,                  /* -mmitigate-rop */
  OPT_mmmx = 1371,                           /* -mmmx */
  OPT_mmovbe = 1372,                         /* -mmovbe */
  OPT_mmovdir64b = 1373,                     /* -mmovdir64b */
  OPT_mmovdiri = 1374,                       /* -mmovdiri */
  OPT_mmpx = 1375,                           /* -mmpx */
  OPT_mms_bitfields = 1376,                  /* -mms-bitfields */
  OPT_mmwaitx = 1377,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1378,            /* -mno-align-stringops */
  OPT_mno_default = 1379,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1380,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1381,                  /* -mno-push-args */
  OPT_mno_red_zone = 1382,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1383,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1384,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1385,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1386,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1387,                          /* -mpc32 */
  OPT_mpc64 = 1388,                          /* -mpc64 */
  OPT_mpc80 = 1389,                          /* -mpc80 */
  OPT_mpclmul = 1390,                        /* -mpclmul */
  OPT_mpcommit = 1391,                       /* -mpcommit */
  OPT_mpconfig = 1392,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1393,            /* -mpe-aligned-commons */
  OPT_mpku = 1394,                           /* -mpku */
  OPT_mpopcnt = 1395,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1396, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1397,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1398,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1399,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1400,                        /* -mprfchw */
  OPT_mptwrite = 1401,                       /* -mptwrite */
  OPT_mpush_args = 1402,                     /* -mpush-args */
  OPT_mrdpid = 1403,                         /* -mrdpid */
  OPT_mrdrnd = 1404,                         /* -mrdrnd */
  OPT_mrdseed = 1405,                        /* -mrdseed */
  OPT_mrecip = 1406,                         /* -mrecip */
  OPT_mrecip_ = 1407,                        /* -mrecip= */
  OPT_mrecord_mcount = 1408,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1409,                 /* -mrecord-return */
  OPT_mred_zone = 1410,                      /* -mred-zone */
  OPT_mregparm_ = 1411,                      /* -mregparm= */
  OPT_mrtd = 1412,                           /* -mrtd */
  OPT_mrtm = 1413,                           /* -mrtm */
  OPT_msahf = 1414,                          /* -msahf */
  OPT_msgx = 1415,                           /* -msgx */
  OPT_msha = 1416,                           /* -msha */
  OPT_mshstk = 1417,                         /* -mshstk */
  OPT_mskip_rax_setup = 1418,                /* -mskip-rax-setup */
  OPT_msoft_float = 1419,                    /* -msoft-float */
  OPT_msse = 1420,                           /* -msse */
  OPT_msse2 = 1421,                          /* -msse2 */
  OPT_msse2avx = 1422,                       /* -msse2avx */
  OPT_msse3 = 1423,                          /* -msse3 */
  OPT_msse4 = 1424,                          /* -msse4 */
  OPT_msse4_1 = 1425,                        /* -msse4.1 */
  OPT_msse4_2 = 1426,                        /* -msse4.2 */
  OPT_msse4a = 1427,                         /* -msse4a */
  /* OPT_msse5 = 1428, */                    /* -msse5 */
  OPT_msseregparm = 1429,                    /* -msseregparm */
  OPT_mssse3 = 1430,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1431,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1432, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1433,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1434, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1435,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1436,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1437,            /* -mstringop-strategy= */
  OPT_mstv = 1438,                           /* -mstv */
  OPT_mtbm = 1439,                           /* -mtbm */
  OPT_mthreads = 1440,                       /* -mthreads */
  ...
  OPT_municode = 1445,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1446,          /* -muse-libstdc-wrappers */
  ...
  OPT_mwin32 = 1454,                         /* -mwin32 */
  OPT_mwindows = 1455,                       /* -mwindows */
  OPT_mx32 = 1456,                           /* -mx32 */
  OPT_mxop = 1457,                           /* -mxop */
  OPT_mxsave = 1458,                         /* -mxsave */
  OPT_mxsavec = 1459,                        /* -mxsavec */
  OPT_mxsaveopt = 1460,                      /* -mxsaveopt */
  OPT_mxsaves = 1461,                        /* -mxsaves */
  OPT_n = 1462,                              /* -n */
  OPT_no_canonical_prefixes = 1463,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1464,              /* -no-integrated-cpp */
  OPT_no_pie = 1465,                         /* -no-pie */
  OPT_no_pthread = 1466,                     /* -no-pthread */
  OPT_nocpp = 1467,                          /* -nocpp */
  OPT_nodefaultlibs = 1468,                  /* -nodefaultlibs */
  OPT_nolibc = 1469,                         /* -nolibc */
  OPT_nophoboslib = 1470,                    /* -nophoboslib */
  OPT_nostartfiles = 1471,                   /* -nostartfiles */
  OPT_nostdinc = 1472,                       /* -nostdinc */
  OPT_nostdinc__ = 1473,                     /* -nostdinc++ */
  OPT_nostdlib = 1474,                       /* -nostdlib */
  OPT_o = 1475,                              /* -o */
  OPT_p = 1476,                              /* -p */
  OPT_pass_exit_codes = 1477,                /* -pass-exit-codes */
  /* OPT_pedantic = 1478, */                 /* -pedantic */
  OPT_pedantic_errors = 1479,                /* -pedantic-errors */
  OPT_pg = 1480,                             /* -pg */
  OPT_pie = 1481,                            /* -pie */
  OPT_pipe = 1482,                           /* -pipe */
  OPT_posix = 1483,                          /* -posix */
  OPT_print_file_name_ = 1484,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1485,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1486,          /* -print-multi-directory */
  OPT_print_multi_lib = 1487,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1488,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1489,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1490,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1491,               /* -print-prog-name= */
  OPT_print_search_dirs = 1492,              /* -print-search-dirs */
  OPT_print_sysroot = 1493,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1494,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1495,                        /* -pthread */
  OPT_quiet = 1496,                          /* -quiet */
  OPT_r = 1497,                              /* -r */
